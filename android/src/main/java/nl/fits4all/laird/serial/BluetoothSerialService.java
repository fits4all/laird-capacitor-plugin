...
public class BluetoothSerialService {
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(BluetoothSerialType.MESSAGE_STATE_CHANGE.getType(), state, -1).sendToTarget();
    }
...
//        }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device, final String socketType) {
        ...
        Message msg = mHandler.obtainMessage(BluetoothSerialType.MESSAGE_DEVICE_NAME.getType());
    ...
    private void connectionFailed() {
        ...
        Message msg = mHandler.obtainMessage(BluetoothSerialType.MESSAGE_TOAST.getType());
        Bundle bundle = new Bundle();
    ...
    private class ConnectedThread extends Thread {
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    mHandler.obtainMessage(BluetoothSerialType.MESSAGE_READ.getType(), data).sendToTarget();
                    ...
                    if (bytes > 0) {
                        ...
                        mHandler.obtainMessage(BluetoothSerialType.MESSAGE_READ_RAW.getType(), rawdata).sendToTarget();
                    }
        ...
        public void write(byte[] buffer) {
            try {
                ...
                mHandler.obtainMessage(BluetoothSerialType.MESSAGE_WRITE.getType(), -1, -1, buffer).sendToTarget();
